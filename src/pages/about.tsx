...
export default function About(): React.ReactElement {
  return (
    <div className={`flex flex-col ${styles.aboutPage}`}>
      ...
      In the spring of 2023, a team of passionate innovators and trivia enthusiasts saw a gap in the market. They recognized the challenges faced by quiz creators in producing engaging and stimulating questions and the lack of a convenient platform for quiz enthusiasts to participate. The idea was simple - to make quiz creation and participation a breeze. Thus, <span className="companyName keepColor">Quizzify-AI</span> was born.
      </p>
      <p className={styles.paragraph}>
      After some time of rigorous research, development, and testing, the <span className="companyName keepColor">Quizzify-AI</span> platform was launched. Utilizing state-of-the-art artificial intelligence algorithms, it aimed to ease the pain of QuizMasters by offering a vast database of exciting questions. The response was overwhelming. Quiz Masters, amateur enthusiasts, and even businesses recognized the platform&rsquo;s potential as a unique tool to engage their audience.
      </p>
      <p className={styles.paragraph}>
      By the end of 2023, <span className="companyName keepColor">Quizzify-AI</span> will become a prominent name in the world of quiz creation and participation. Its user-friendly interface and the AI-powered engine, coupled with the endless possibilities of quiz customization, allows it to stand out among its competitors. The platform&rsquo;s reach expands beyond geographical boundaries, connecting trivia enthusiasts worldwide, and fostering a sense of community among its users.
      </p>
      <p className={styles.paragraph}>
      Fast forward to the present, <span className="companyName keepColor">Quizzify-AI</span> is celebrated as a leading online quizzing platform. It has significantly reshaped the landscape of trivia quizzing and has brought a wave of innovation to this age-old leisure activity.
      </p>
      <h2>The Future of <span className="companyName keepColor">Quizzify-AI</span></h2>
      <p className={styles.paragraph}>
        As <span className="companyName keepColor">Quizzify-AI</span> looks toward the future, the vision remains as strong as ever: to continuously simplify and enhance the quizzing experience for everyone. The following are the strategic initiatives outlined for the future:
      </p>
      <ol>
        <li>
          <p className={styles.paragraph}>
